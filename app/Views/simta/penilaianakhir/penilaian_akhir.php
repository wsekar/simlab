...
<body>
    ...
    <hr class="line-title">
    <h6 class="text-center"><b>FORMULIR PENILAIAN AKHIR KEGIATAN TUGAS AKHIR</b></h6>
    <br>
    <div class="row">
        <table class="px-3">
            <tr>
                ...
                <?php foreach($mahasiswa as $mhs) {
                    echo ($penilaianakhir->id_mhs == $mhs->id_mhs) ? $mhs->nama : ''; } ?>
                </td>
            </tr>
            <tr>
                <td>NIM</td>
                ...
                <td class="pl-2 text-justify">
                <?php foreach($mahasiswa as $mhs) {
                    echo ($penilaianakhir->id_mhs == $mhs->id_mhs) ? $mhs->nim : ''; } ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="pl-2 text-justify">
                <?php foreach($mahasiswa as $mhs) {
                    echo ($penilaianakhir->id_mhs == $mhs->id_mhs) ? $mhs->prodi : ''; } ?>
                </td>
            </tr>
            <tr>
                ...
                <?php foreach($ujianproposal as $up) {
                    echo ($penilaianakhir->id_ujianproposal == $up->id_ujianproposal) ? $up->nama_judul : ''; } ?>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="table-border">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $no++; ?></td>
                <td><?= $penilaianakhir->nilai_ujianproposal ?></td>
                <td><?= $penilaianakhir->nilai_seminarhasil ?></td>
                <td><?= $penilaianakhir->nilai_ujianta ?></td>
            </tr>
            <tr>
                <td class="text-uppercase" style="text-align:right; padding-right:20px;" colspan="3"><b>Jumlah Total</b></td>
                <td class="text-center"><?= $penilaianakhir->hasilakhir ?></td>
            </tr>
        </tbody>
    </table>
    <!-- </div> -->
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="left:65%;">
            ...
            <?php foreach($staf as $s) {
                    echo ($penilaianakhir->id_staf == $s->id_staf) ? $s->nama : ''; } ?>
            </u></span>
            <br>
            <span>NIP. <?php foreach($staf as $s) {
                    echo ($penilaianakhir->id_staf == $s->id_staf) ? $s->nip : ''; } ?></span>
        </div>
    </div>
</body>
