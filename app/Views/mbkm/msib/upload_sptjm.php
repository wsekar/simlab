...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Upload Berkas MBKM MSIB</h2>
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <form method="POST"
                                    action="<?=base_url('mbkm/msib/proses-upload-sptjm/' . $msib->id_msib);?>"
                                    enctype="multipart/form-data">
                                    <?=csrf_field();?>


                                    <div class="form-group mb-3">
                                        <label for="customFile">SPTJM </label>
                                        <input type="file"
                                            class="form-control <?=($validation->hasError('sptjm')) ? 'is-invalid' : '';?>"
                                            name="sptjm" required>
                                        <div class="invalid-feedback">
                                            <?=$validation->getError('sptjm');?>
                                        </div>
