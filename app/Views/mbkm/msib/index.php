    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2 class="page-title">Halaman Pendaftaran MBKM MSIB</h2>
                        <p class="card-text">
                            Pendaftaran MBKM MSIB (Kemendikbud)
                        </p>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right text-sm">
                            ...
                            <li class="breadcrumb-item active"><small>Pendaftaran MBKM MSIB</small></li>
                        </ol>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <a href="<?=base_url('mbkm/msib/tambah');?>" class="btn btn-primary mb-3">Tambah</a>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-success"
                                                        href="<?=base_url('mbkm/monitoring/tambah-dosen/' . $a->id_msib)?>">
                                                        <span class="fe fe-check fe-16 align-middle"></span>
                                                    </a>
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-danger"
                                                        href="<?=base_url('mbkm/msib/dosen/verifikasi-tidak-disetujui/' . $a->id_msib)?>">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/upload-berkas/$a->id_msib");?>">Upload
                                                            SR</a>
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/upload-sptjm/$a->id_msib");?>">Upload
                                                            SPTJM</a>
                                                    </div>
                                                    <?php else: ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/detail/$a->id_msib");?>">Detail</a>

                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/edit/$a->id_msib");?>">Edit
                                                            Pendaftaran</a>
                                                        <form action="<?=base_url("mbkm/msib/hapus/$a->id_msib");?>">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/detail/$a->id_msib");?>">Detail</a>
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/edit-status-mhs/$a->id_msib");?>">Edit
                                                            Status Mahasiswa</a>
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/edit/$a->id_msib");?>">Edit
                                                            Pendaftaran</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($k->status_dosen == 'pending'): ?>
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-success"
                                                        href="<?=base_url('mbkm/msib/dosen/verifikasi-setujui/' . $k->id_msib)?>">
                                                        <span class="fe fe-check fe-16 align-middle"></span>
                                                    </a>
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-danger"
                                                        href="<?=base_url('mbkm/msib/dosen/verifikasi-tidak-disetujui/' . $k->id_msib)?>">
                                                        <span class="fe fe-x fe-16 align-middle"></span>
                                                    </a>
                                                    <?php else: ?>
                                                    <span class="badge badge-success">Sudah diverifikasi</span>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/msib/detail/$k->id_msib");?>">Detail</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item"
                                                            ...
                                                            Pendaftaran</a>
                                                        <form method="POST"
                                                            action="<?=base_url("mbkm/msib/hapus/$a->id_msib");?>">
                                                            <input name="_method" type="hidden" value="DELETE">
                                                            <button type="submit" class="dropdown-item remove-item-btn"
                                                                data-toggle="tooltip" title='Delete'><i
                                                                    class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>
...
$(document).ready(function() {
    ...
    $('#prosesFilter').on('click', function(event) {
        ...
        if (th_masuk != '') {
            <?php if(has_permission('admin')|| has_permission('koor-mbkm')): ?>
            var url = "<?php echo base_url('mbkm/msib/filter-msib'); ?>" +
                "/" +
                th_masuk;
            <?php elseif(has_permission('dosen')): ?>
            var url = "<?php echo base_url('mbkm/msib/filter-msib-dsn'); ?>" + "/" +
                th_masuk;
            <?php endif; ?>
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(i, item) {
                    var url_detail = '<?= base_url('mbkm/msib/detail'); ?>' +
                        '/' + item.id_msib;
                    var url_delete = '<?= base_url('mbkm/msib/hapus'); ?>' +
                        '/' + item.id_msib;
                    var url_edit = '<?= base_url('mbkm/msib/edit'); ?>' + '/' +
                        item.id_msib;
                    ...
                    var url_tidak_disetujui =
                        ...
                        "/" + item.id_msib;
                    var url_sr =
                        "<?= base_url('mbkm/msib/upload-berkas'); ?>" +
                        "/" + item.id_msib;
                    var url_sptjm =
                        "<?= base_url('mbkm/msib/upload-sptjm'); ?>" +
                        "/" + item.id_msib;
                    var url_editStatusMahasiswa =
                        "<?= base_url('mbkm/msib/edit-status-mhs'); ?>" +
                        "/" + item.id_msib;
                    ...
                    <?php if(has_permission('admin')|| has_permission('koor-mbkm')): ?>
                        .append('<tr><td>' + (i++ + 1) +
                            ...
                            '</td><td>' + item.nama_instansi + '</td><td>' +
                            ...
                            url_sr +
                            '">Upload SR</a><a class="dropdown-item" href="' +
                            url_sptjm +
                            '">Upload SPTJM</a><form method="POST" action="' +
                            '"></form>' +
                            '</td><td>' +
