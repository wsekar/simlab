                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <form method="POST"
                                    action="<?= base_url('mbkm/penilaian/uas/simpan/dosen/uas/' . $mbkm->id_mbkm_fix); ?>"
                                    ...
                                    <div class="form-group">
                                        <?php foreach ($pertanyaan_dsn_uas as $p) { ?>
                                        <input type="hidden" name="id_pertanyaan_uas[]"
                                            value="<?= $p->id_pertanyaan_uas ?>"> <label
                                            class="mt-2"><?= ($p->id_pertanyaan_uas) ? $p->pertanyaan : '' ?>
