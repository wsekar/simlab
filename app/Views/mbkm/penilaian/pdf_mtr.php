...
<body>
    ...
    <hr class="line-title">
    <h6 class="text-center"><b>FORMULIR PENILAIAN UTS MAHASISWA MBKM - MITRA</b></h6>
    <br>
    <div class="row">
        <table class="px-3">
            <tr>
    ...
    <table class="table-border">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php
                        foreach ($penilaianUtsMtr as $pn) {
                            if($p->id_pertanyaan_uts == $pn->id_pertanyaan_uts){
                                echo $pn->nilai;
                            }
                        }
                    ?>
            ...
            <tr>
                ...
                <td class="text-center"><?= $totalMtr ?></td>
            </tr>
        </tbody>
    </table>
    <!-- </div> -->
