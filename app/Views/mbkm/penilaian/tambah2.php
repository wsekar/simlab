...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Penilaian UTS MBKM</h2>
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <form method="POST"
                                    action="<?= base_url('mbkm/penilaian/simpan/dosen/' . $mbkm->id_mbkm_fix); ?>"
                                    ...
                                    <div class="form-group">
                                        <?php foreach ($pertanyaan_dsn_uts as $p) { ?>
                                        <input type="hidden" name="id_pertanyaan_uts[]"
                                            value="<?= $p->id_pertanyaan_uts ?>">
                                        <?php if ($p->nama_mata_kuliah =='' ): ?>

                                        <label class="mt-2"><?= ($p->id_pertanyaan_uts) ? $p->pertanyaan : '' ?>
                                            ( Softskill )</label>
                                        <?php else: ?>
                                    ...
                                    <a href="<?= base_url('mbkm/penilaian/uts'); ?>" class="btn btn-warning">Kembali</a>
                                </form>
                            </div>
                            <!-- /.card-body -->
                        </div>
