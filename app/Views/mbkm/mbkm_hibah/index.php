    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2 class="page-title">Halaman Pendaftaran MBKM Hibah</h2>
                        <P>Pendaftaran MBKM Hibah UNS</P>
                    </div>
                    <?php if (has_permission('admin')): ?>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right text-sm">
                            ...
                            <li class="breadcrumb-item active"><small>Pendaftaran MBKM Hibah UNS</small></li>
                        </ol>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-success"
                                                        href="<?=base_url('mbkm/msib/dosen/verifikasi-setujui/' . $a->id_hibah)?>">
                                                        <span class="fe fe-check fe-16 align-middle"></span>
                                                    </a>
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-danger"
                                                        href="<?=base_url('mbkm/msib/dosen/verifikasi-tidak-disetujui/' . $a->id_hibah)?>">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/hibah/upload-sr/$a->id_hibah");?>">Upload
                                                            SR</a>
                                                    </div>
                                                    <?php else: ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/hibah/detail/$a->id_hibah");?>">Detail</a>
                                                        <a class="dropdown-item"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($k->status_dosen == 'pending'): ?>
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-success"
                                                        href="<?=base_url('mbkm/hibah/dosen/verifikasi-setujui/' . $k->id_hibah)?>">
                                                        <span class="fe fe-check fe-16 align-middle"></span>
                                                    </a>
                                                    <a class="mx-1 my-1 btn btn-sm btn-outline-danger"
                                                        href="<?=base_url('mbkm/hibah/dosen/verifikasi-tidak-disetujui/' . $k->id_hibah)?>">
                                                        <span class="fe fe-x fe-16 align-middle"></span>
                                                    </a>
                                                    <?php else: ?>
                                                    <span class="badge badge-success">Sudah diverifikasi</span>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/hibah/detail/$k->id_hibah");?>">Detail</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php }?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <?php if ($a->status_mahasiswa == 'diambil' || $a->status_mahasiswa == 'tidak diambil'): ?>
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/hibah/detail/$a->id_hibah");?>">Detail
                                                        </a>
                                                        <?php else: ?>
                                                        <a class="dropdown-item"
                                                            href="<?=base_url("mbkm/hibah/detail/$a->id_hibah");?>">Detail
...
$(document).ready(function() {
    ...
    $('#prosesFilter').on('click', function(event) {
        ...
        if (th_masuk != '') {
            <?php if (has_permission('admin') || has_permission('koor-mbkm')): ?>
            var url = "<?php echo base_url('mbkm/hibah/filter-hibah'); ?>" +
                "/" +
                th_masuk;
            <?php elseif (has_permission('dosen')): ?>
            var url = "<?php echo base_url('mbkm/hibah/filter-hibah-dsn'); ?>" + "/" +
                th_masuk;
            <?php endif;?>
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(i, item) {
                    var url_detail = '<?=base_url('mbkm/hibah/detail');?>' +
                        '/' + item.id_mprodi;
                    var url_delete = '<?=base_url('mbkm/hibah/hapus');?>' +
                        '/' + item.id_mprodi;
                    var url_edit = '<?=base_url('mbkm/hibah/edit');?>' + '/' +
                        item.id_mprodi;
                    var url_disetujui =
                        "<?=base_url('mbkm/hibah/dosen/verifikasi-disetujui');?>" +
                        "/" + item.id_mprodi;
                    var url_tidak_disetujui =
                        "<?=base_url('mbkm/hibah/dosen/verifikasi-tidak-disetujui');?>" +
                        "/" + item.id_mprodi;
                    var url_sr =
                        "<?=base_url('mbkm/hibah/upload-sr');?>" +
                        "/" + item.id_mprodi;
                    var url_sptjm =
                        "<?=base_url('mbkm/hibah/upload-sptjm');?>" +
                        "/" + item.id_mprodi;
                    var url_editStatusMahasiswa =
                        "<?=base_url('mbkm/hibah/edit-status-mhs');?>" +
                        "/" + item.id_mprodi;
