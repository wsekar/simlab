...
<main role="main" class="main-content">
    ...
    <div class="row my-3">
        ...
        <div class="col-md-12">
            <div class="row mb2">
                <div class="col-sm-6">
                    <h2 class="page-title">Monitoring Kegiatan MBKM MSIB</h2>
                    <p class="card-text">
                        Data Mahasiswa Aktif Kegiatan MBKM MSIB
                    </p>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right text-sm">
                        ...
                        <li class="breadcrumb-item active"><small>Monitoring MSIB</small></li>
                    </ol>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-outline-primary" type="button"
                                            href="<?=base_url('mbkm/monitoring/detail-msib/' . $a->id_mbkm_fix)?>">Monitoring</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                                <?php
...
$(document).ready(function() {
    ...
    $('#prosesFilter').on('click', function(event) {
        ...
        if (th_masuk != '') {
            <?php if (has_permission('admin') || has_permission('koor-mbkm')): ?>
            var url = "<?php echo base_url('mbkm/monitoring/filter-adm-msib'); ?>" +
                "/" +
                th_masuk;
            <?php elseif (has_permission('dosen')): ?>
            var url = "<?php echo base_url('mbkm/monitoring/filter-dsn-msib'); ?>" + "/" +
                th_masuk;
            <?php endif;?>
        }
    ...
    $(document).ready(function() {
        $('#resetFilter').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url('mbkm/monitoring/msib'); ?>',
                method: "GET",
                dataType: 'json',
                success: function(data) {
                    // Tampilkan data ke dalam tabel
