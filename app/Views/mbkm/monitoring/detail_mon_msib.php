...
<main role="main" class="main-content">
    ...
    <div class="row my-3">
        ...
        <div class="col-md-12">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2 class="page-title">Detal Monitoring Mahasiswa MBKM MSIB</h2>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right text-sm">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="<?= base_url('mbkm/monitoring/msib') ?>"><small>Monitoring MSIB</small></a></li>
            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <!-- table -->
                    <a href="<?=base_url('mbkm/monitoring/msib');?>" class="btn btn-secondary bt-sm mb-3">Kembali</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-outline-primary"
                                            href="<?=base_url('mbkm/monitoring/tambah-dosen-msib/' . $a->id_monitoring)?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item"
                                                href="<?=base_url('mbkm/monitoring/tambah-dosen-msib/' . $a->id_monitoring);?>">Feedback
                                            </a>
                                            <form method="POST"
                                                action="<?=base_url("mbkm/monitoring/hapus/$a->id_monitoring");?>">
                                                <input name="_method" type="hidden" value="DELETE">
