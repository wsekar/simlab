...
<main role="main" class="main-content">
    ...
    <div class="row my-3">
        ...
        <div class="col-md-12">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2 class="page-title">Detail Monitoring Mahasiswa MBKM Prodi</h2>
                </div>
                <?php if (has_permission('admin')): ?>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right text-sm">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="<?=base_url('mbkm/monitoring/mbkm-prodi')?>"><small>Monitoring Prodi</small></a>
                        </li>
...
if (has_permission('admin')):
    $no = 1;
    foreach ($MonDetailProdiAdm as $a):
        // dd($MonDetailMsibAdm); ?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$a->tanggal?></td>
                                    ...
                                    <td>
                                        ...
                                        <span class="btn btn-sm btn-outline-primary"
                                            href="<?=base_url('mbkm/monitoring/tambah-dosen/' . $a->id_monitoring)?>"><a>Beri
                                                Feedback</a></span>
                                        <?php else: ?>
...
elseif (has_permission('dosen')):
    $no = 1;
    foreach ($MonDetailProdiDsn as $a): ?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$a->tanggal?></td>
                                    <td><?=$a->deskripsi?></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-outline-primary"
                                            href="<?=base_url('mbkm/monitoring/tambah-dosen/' . $a->id_monitoring)?>">
