...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Edit Data Pertanyaan UTS MBKM</h2>
                <div class="row my-4">
                    <div class="col">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST"
                                    action="<?=base_url('mbkm/pertanyaan/update/' . $pertanyaanUts->id_pertanyaan_uts)?>">
                                    <div class="form-group mb-3">
                                        <label for="address-wpalaceholder">Pertanyaan</label>
                                        <textarea type="text" id="address-wpalaceholder" name="pertanyaan"
                                            class="form-control" placeholder=""
                                            value="<?= $pertanyaanUts->pertanyaan ?>"><?= $pertanyaanUts->pertanyaan ?> </textarea>
                                        <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control select2" name="nama_mata_kuliah"
                                            ...
                                            <option value="<?= $m->nama_mata_kuliah ?>"
                                                <?= $pertanyaanUts->nama_mata_kuliah == $m->nama_mata_kuliah ? 'selected' : null ?>>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="jenis_penilai"
                                            ...
                                            <option value="dosen"
                                                <?= $pertanyaanUts->jenis_penilai == 'dosen' ? 'selected' : ''; ?>>Dosen
                                            </option>
                                            <option value="mitra"
                                                <?= $pertanyaanUts->jenis_penilai == 'mitra' ? 'selected' : ''; ?>>Mitra
                                            </option>
                                        </select>
