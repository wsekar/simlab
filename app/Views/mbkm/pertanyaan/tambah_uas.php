...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Tambah Pertanyaan UAS</h2>
                <div class="row my-4">
                    <div class="col">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data"
                                    action="<?=base_url("mbkm/pertanyaan/simpan_uas")?>"> <?=csrf_field();?>
                                    <div class="form-group mb-3">
                                        <label for="address-wpalaceholder">Pertanyaan UAS</label>
