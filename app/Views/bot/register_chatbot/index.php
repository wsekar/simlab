      ...
      <div class="row align-items-center h-100">
        <form class="col-lg-6 col-md-8 col-10 mx-auto">
          <div class="mx-auto text-center my-4">
            ...
            <h2 class="my-3">Register Chatbot</h2>
          </div>
          <div class="form-group">
            <label for="inputEmail4">Email Student</label>
          ...
          <div class="row mb-4">
            <div class="col-md-6">
              <div class="form-group">
                <label for="inputPassword5">Nomor Whatsapp</label>
                <input type="text" class="form-control" id="inputPassword5">
              </div>
            </div>
            <div class="col-md-6">
              <p class="mb-2">Nomor Whatsapp Aktif</p>
              <p class="small text-muted mb-2"> Masukkan Nomor Yang Terdaftar Di Whatsapp: </p>
            </div>
          </div>
