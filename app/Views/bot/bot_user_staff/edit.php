    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2 class="page-title">Edit User Staf</h2>
                    </div>
                </div>
                <div class="col-md-12">
                <div class="card shadow mb-4">
                  <div class="card-header">
                    <strong class="card-title">Form Edit User Staf</strong>
                  </div>
                  <div class="card-body">
                ...
                <br>
                  <?php foreach ($staf as $staf): ?>
                    <form method="POST" action="<?=base_url("bot/kelola_bot/user/staf/simpan-edit/". $staf->id_user_bot)?>" onsubmit="disableButton()">
                    <div class="form-group mb-3">
                        <label for="simpleinput">Nama Staff/ Dosen</label>
                        <input readonly=""  required value="<?=$staf->nama?>" type="text" id="simpleinput" name="nama" class="form-control">
                      </div>
                      <div class="form-group mb-3">
                        <label for="simpleinput">Email</label>
                        <input required value="<?=$staf->email?>" type="text" id="simpleinput" name="email" class="form-control">
                      </div>
                      <div class="form-group mb-3">
                        <label for="simpleinput">Telegram</label>
                        <input required readonly="" value="<?=$staf->username_telegram?>" type="text" id="simpleinput" name="telegram" class="form-control">
                      </div>
                      <div class="form-group mb-3">
                        <label for="simpleinput">Whatsapp</label>
                        <input required value="<?=$staf->no_wa?>" type="text" id="simpleinput" name="whatsapp" class="form-control">
                      </div>
                      <div class="form-group mb-3">
