    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2 class="page-title">Chatbot User Staff dan Dosen</h2>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right text-sm">
                            ...
                            <li class="breadcrumb-item active"><small>User Staff</small></li>
                        </ol>
                    </div>
                    <?php endif;?>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <td>
                                                    ...
                                                    <a class="dropdown-item" href="<?=base_url("bot/kelola_bot/user/staf/edit/$mhs->id_user_bot");?>"><i class="fe fe-edit fe-16"></i> Edit</a>
                                                    <form method="POST" action="<?=base_url("bot/kelola_bot/user/staf/hapus-staf/$mhs->id_user_bot");?>">
