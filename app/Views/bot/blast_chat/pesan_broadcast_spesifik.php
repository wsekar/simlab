            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header">
                    <strong class="card-title">Kirim Broadcast Mahasiswa Spesifik</strong>
                  </div>
                  <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="<?=base_url("bot/blast_chat/broadcast_spesifik/kirim")?>" onsubmit="return disableButton()">
                    <div class="form-group row">
                      <label class="col-sm-3" for="inputPenerima">Angkatan</label>
                      <div class="col-sm-9">
                      <select name="angkatan" id="inputPenerima" rows="2"
                                            class="form-control select2">
                                            <option value ="">Pilih Angkatan</option>
                                            <?php foreach ($angkatan as $a) : ?>
                                              <option value="<?= $a->th_masuk?>"><?=$a->th_masuk?></option>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                         </div>
                      ...
                      <div class="form-group row">
                      <label class="col-sm-3" for="inputPenerima">Kelas</label>
                      <div class="col-sm-9">
                      <select name="kelas" id="inputPenerima" rows="2"
                                            class="form-control select3">
                                            <option value ="">Pilih Kelas | Jika Tidak Dipilih Maka Dikirim Ke Satu Angkatan</option>
