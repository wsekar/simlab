                    ...
                    <div class="row my-4">
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url("bot/blast_chat/terjadwal/kirim")?>" onsubmit="return disableButton()">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group date">
                                                        <input id="example-date" name="tanggal[]" type="text" class="form-control drgpicker" readonly>
    ...
    $('.input-group.date .drgpicker').datepicker({
        format: 'yyyy-mm-dd',
        autoclose: true,
        todayHighlight: true
    });
