        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    <div class="col">
                        <h2 class="h5 page-title">Selamat Datang <?= user()->username; ?></h2>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="card-text my-2">
                                    <p><?=$ag->deskripsi_agenda ?></p>
                                </div>
                            </div> <!-- ./card-text -->
                            <div class="card-footer">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto">
                                            <small><span class="bg-success mr-1"></span>Batas Pengisian: <?=$ag->waktu_kegiatan ?></small>
                                    </div>
