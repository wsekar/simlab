...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Edit Agenda</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('tracer/agenda/update/' . $agenda->id_agenda) ?>">
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Nama</label>
                                        <input type="text" id="address-wpalaceholder" name="nama_agenda" class="form-control" placeholder="Masukkan Pertanyaan" value="<?= $agenda->nama_agenda ?>" />
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <textarea class="form-control" id="example-textarea" name="deskripsi_agenda" placeholder="Masukan Deskripsi"><?= $agenda->deskripsi_agenda ?></textarea>
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <div class="md-form md-outline input-with-post-icon datepicker">
                                            <input placeholder="Masukan Tanggal" name="waktu_kegiatan" type="date" id="example" class="form-control" value="<?= $agenda->waktu_kegiatan ?>">
                                        </div>
                                            <!-- Error Validation -->
