...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">Halaman Data Agenda</h2>
                <?php
                ...
                <div class="row my-4">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <a href="<?= base_url('tracer/agenda/tambah'); ?>" class="btn btn-primary mb-3">Tambah</a>
                                <!-- table -->
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item"
                                                        href="<?= base_url("tracer/agenda/edit/$ag->id_agenda"); ?>">Edit</a>
                                                    <form method="POST"
                                                        action="<?= base_url("tracer/agenda/hapus/$ag->id_agenda"); ?>">
