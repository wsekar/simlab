...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Edit FAQ</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('tracer/faq/update/' . $faq->id_faq) ?>">
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Pertanyaan</label>
                                        <input type="text" id="address-wpalaceholder" name="pertanyaan" class="form-control" placeholder="Masukkan Pertanyaan" value="<?= $faq->pertanyaan ?>" />
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <input type="text" id="address-wpalaceholder" name="jawaban" class="form-control" placeholder="Masukkan Jawaban" value="<?= $faq->jawaban ?>" />
                                            <!-- Error Validation -->
