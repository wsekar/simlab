...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Tambah Tahun</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url("tracer/tahun/simpan") ?>">
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Tahun</label>
                                        <input type="text" id="address-wpalaceholder" name="tahun" class="form-control" placeholder="Masukkan Tahun" />
                                            <!-- Error Validation -->
