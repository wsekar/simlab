...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Tambah Jenis Kuesioner</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url("tracer/jenis_kuesioner/simpan") ?>">
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Nama</label>
                                        <input type="text" id="address-wpalaceholder" name="nama" class="form-control" placeholder="Masukkan Nama Jenis Kuesioner" />
                                            <!-- Error Validation -->
