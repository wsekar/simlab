...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Tambah Pertanyaan Kuesioner</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url("tracer/pertanyaan_kuesioner/simpan") ?>">
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <input type="text" id="address-wpalaceholder" name="pilihan1" class="form-control" placeholder="Masukkan Pilihan 1" />
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <input type="text" id="address-wpalaceholder" name="pilihan2" class="form-control" placeholder="Masukkan Pilihan 2" />
                                            <!-- Error Validation -->
                                            <?php if ($validation->getError('pilihan2')) { ?>
                                            <div class='alert alert-danger mt-2'>
                                                <?= $error = $validation->getError('pilihan2'); ?>
                                            </div>
                                            <?php } ?>
                                    </div>
