...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Tambah Informasi Magang</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url("tracer/informasi_magang/simpan") ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <input type="text" id="address-wpalaceholder" name="posisi_magang" class="form-control" placeholder="Masukkan Posisi Magang" />
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <textarea type="text" class="form-control" name="persyaratan_magang"></textarea>
                                    ...
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Batas Informasi</label>
