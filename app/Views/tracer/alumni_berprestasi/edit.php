...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Form Edit Alumni Berprestasi</h2>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow mb-10">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('tracer/alumni_berprestasi/update/' . $alumni_berprestasi->id_alumni_berprestasi) ?>" enctype="multipart/form-data">
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Nama Mahasiswa</label>
                                        <input type="text" id="address-wpalaceholder" name="nama_mahasiswa" class="form-control" placeholder="Masukkan Nama Mahasiswa" value="<?= $alumni_berprestasi->nama_mahasiswa ?>" />
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        ...
                                        <input type="text" id="address-wpalaceholder" name="program_study" class="form-control" placeholder="Masukkan Prodi" value="<?= $alumni_berprestasi->program_study ?>" />
                                            <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-9">
                                        <label for="address-wpalaceholder">Prestasi</label>
                                        <input type="text" id="address-wpalaceholder" name="prestasi" class="form-control" placeholder="Masukkan Prestasi" value="<?= $alumni_berprestasi->prestasi ?>" />
                                            <!-- Error Validation -->
