            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header">
                    <strong class="card-title">Tambah Kegiatan Prodi</strong>
                  </div>
                  <div class="card-body">
                    <form method="POST" action="<?=base_url("timelinereminder/agenda/tambah/simpan")?>" onsubmit="disableButton()">
                    <div class="form-group mb-3">
                        <label for="simpleinput">Nama Kegiatan</label>
                        <input type="text" id="simpleinput" name="nama_kegiatan" class="form-control" required>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-12" name= "pesan" for="exampleFormControlTextarea1">Deskripsi Kegiatan</label>
                        <div class="col-sm-12">
                          <textarea class="form-control" placeholder="Penjelasan Kegiatan" name= "deskripsi_kegiatan" id="exampleFormControlTextarea1" rows="2" required></textarea>
                               <!-- Error Validation -->
                        </div>
                      </div>
                      <div class="form-group mb-3">
                                        ...
                                        <select name="id_staf"
                                            ...
                                            <option required value="<?= $s->id_staf ?>"><?= $s->nama ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
