            ...
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    ...
                    <div class="alert alert-info" role="alert">
                        <span class="fe fe-smile fe-16 mr-2"></span><b>Selamat Datang di Sistem Informasi Prodi D3 Teknik Informatika Madiun</b></div>
                        </h2>
                    </div>
                </div>
                <!-- .row -->
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="card-text my-2">
                                    <strong class="card-title my-0">Staf</strong>
                                    <p><?= $jumlah_staf; ?></p>
                                </div>
                            </div> <!-- ./card-text -->
                    ...
                    <div class="col-md-3">
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="card-text my-2">
                                    <strong class="card-title my-0">Mahasiswa</strong>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                <div class="avatar avatar-lg mt-4">
                                    <a href="">
                                        <i class="fe fe-briefcase" style="font-size: 4em;"></i>
                                    </a>
                                </div>
                                <div class="card-text my-2">
                                    <strong class="card-title my-0">Mitra</strong>
                                    <p><?= $jumlah_mitra; ?></p>
                                </div>
                            </div> <!-- ./card-text -->
                            <div class="card-footer">
                    ...
                    <div class="col-md-3">
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="card-text my-2">
                                    <strong class="card-title my-0">Mata Kuliah</strong>
                                    <p><?= $jumlah_mata_kuliah; ?></p>
                                </div>
                            </div> <!-- ./card-text -->
                            <div class="card-footer">
                                <div class="row align-items-center justify-content-between">
