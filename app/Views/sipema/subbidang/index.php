                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <table class="table datatables" id="dataTableSubBidang">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($DetailSubBidang as $dsb) : ?>
                                            <tr>
                                                <td style="visibility: hidden;"><?= $dsb->nama_bidang ?></td>
                                                <?php if (has_permission('pimpinan')) : ?>
                                                <?php else : ?>
                                                <td style="display: none;"><?= $dsb->id_sub_bidang ?></td>
                                                <?php endif; ?>
                                                <td style="visibility: hidden;"><?= $dsb->nama_sub_bidang ?></td>
                                                <td><?= $dsb->nama_dosen ?></td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php endforeach ?>
                                    </tbody>
