    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2 class="page-title">Halaman Pengelolaan Data Bobot</h2>
                    </div>
                    <?php if(has_permission('admin')) : ?>
                        <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <?php else : ?>
                                <a href="<?= base_url('sipema/bobot/tambah'); ?>" class="btn btn-primary mb-3">Tambah</a>
                                <?php endif; ?>
                                ...
                                <table class="table datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $b->jenis_bobot ?></td>
                                            <td><?= $b->nilai_bobot * 100?>% (<?= $b->nilai_bobot ?>)</td>
                                            <?php if(has_permission('pimpinan')) : ?>
                                            <?php else : ?> 
                                            <td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?= base_url("sipema/bobot/edit/$b->id_bobot"); ?>"><i class="fe fe-edit fe-16"></i> Edit</a>
                                                    <form method="POST" action="<?= base_url("sipema/bobot/hapus/$b->id_bobot"); ?>">
