    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row">
                    <div class="col-sm-8">
                        <h2 class="mt-2 page-title">Halaman Edit Indikator Penilaian KMM</h2>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <form method="POST"
                                    action="<?= base_url('kmm/pertanyaan-penilaian/update/' . $pertanyaan->id_pertanyaan); ?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="jenis_pertanyaan"
                                            ...
                                            <option value="dosen"
                                                <?= $pertanyaan->jenis_pertanyaan == 'dosen' ? 'selected' : ''; ?>>Dosen
                                            </option>
                                            <option value="mitra"
                                                <?= $pertanyaan->jenis_pertanyaan == 'mitra' ? 'selected' : ''; ?>>Mitra
                                            </option>
                                        </select>
                                        <div class="invalid-feedback">
