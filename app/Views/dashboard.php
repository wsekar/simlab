<?php echo $this->include('partial/dashboard/header');?>
<?php echo $this->include('partial/dashboard/top_menu');?>
<?php echo $this->include('partial/dashboard/side_menu');?>
...
<?php echo $this->include('partial/dashboard/footer');?>