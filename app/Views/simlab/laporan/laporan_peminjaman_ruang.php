...
<body>
    ...
    <hr class="line-title">
    <h6 class="text-center"><b>Laporan Peminjaman Ruang Laboratorium</b></h6>
    <br>
    <div class="box">
        <table class="table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=$dt->hari?>/<?=date('d M Y', strtotime($dt->tanggal_pinjam))?></td>
                    <td><?=$dt->waktu_mulai?> - <?=$dt->waktu_selesai?> WIB</td>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
