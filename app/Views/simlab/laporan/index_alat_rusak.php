                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Laporan Alat Laboratorium Rusak</strong>
                            </div>
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-md-4">
                                ...
                                <table class="table datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$alatlab->tanggal_perubahan?></td>
    ...
    $(document).ready(function() {
        $('#filter').on('click', function(event) {
            ...
            if (tanggal_awal == '' || tanggal_akhir == '' || id_ruang == '') {
                Swal.fire('Error', 'Isi Semua Kolom Untuk Melakukan Filter Data Alat Rusak', 'error');
            }
            $.ajax({
                url: "<?=base_url('simlab/laporan/filter-alat-rusak');?>" + "/" + id_ruang +
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, item) {
                        $('#dataTable-1 tbody').append(
                            ...
                            item.tanggal_perubahan + '</td><td>' + item
        ...
        $('#download').on('click', function(event) {
            ...
            if (tanggal_awal == '' || tanggal_akhir == '' || id_ruang == '') {
                ...
                var url = "<?=base_url('simlab/laporan/alat-rusak/download-pdf/');?>" + "/" + id_ruang +
                    "/" + tanggal_awal + "/" + tanggal_akhir;
                $.ajax({
                    url: url,
                    method: 'get',
