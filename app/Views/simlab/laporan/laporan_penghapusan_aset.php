...
<body>
    ...
    <hr class="line-title">
    <h6 class="text-center"><b>Laporan Penghapusan Aset Laboratorium</b></h6>
    <br>
    <div class="row">
        ...
        <table class="table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=$dt->nama_alat?></td>
                    <td>
                        <?php if ($dt->nama_kategori == 'Peralatan'): ?>
                        <?=$dt->no_inventaris?>
                        <?php elseif ($dt->nama_kategori == 'Barang Habis Pakai'): ?>
                        -
                        <?php endif;?>
                    </td>
                    <td><?=$dt->tanggal_penghapusan?></td>
                    <td><?=$dt->jumlah_penghapusan?> <?=$dt->satuan?></td>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
