                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Form Tambah Data Ruang Laboratorium</strong>
                            </div>
                            <div class="card-body">
                                <!-- table -->
                                <form method="POST" action="<?=base_url("simlab/ruang-laboratorium/simpan")?>">
                                    <div class="form-group mb-3">
                                        <label for="nama_ruang">Nama Ruang</label>
                                        <input type="text" id="nama_ruang" name="nama_ruang"
                                            class="form-control <?=($validation->hasError('nama_ruang')) ? 'is-invalid' : ''?>"
                                            value="<?=set_value('nama_ruang')?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="Gedung 1" <?= set_select('gedung', 'Gedung 1'); ?>>Gedung 1
                                            </option>
                                            <option value="Gedung 2" <?= set_select('gedung', 'Gedung 2'); ?>>Gedung 2
                                            </option>
                                        </select>
                                        <!-- Error Validation -->
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="Lantai 1" <?= set_select('lantai', 'Lantai 1'); ?>>Lantai 1
                                            </option>
                                            <option value="Lantai 2" <?= set_select('lantai', 'Lantai 2'); ?>>Lantai 2
                                            </option>
                                            <option value="Lantai 3" <?= set_select('lantai', 'Lantai 3'); ?>>Lantai 3
                                            </option>
                                        </select>
                                        <!-- Error Validation -->
                                        <div class="invalid-feedback">
