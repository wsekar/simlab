                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Form Edit Data Penghapusan Aset</strong>
                            </div>
                            <div class="card-body">
                                <!-- table -->
                                <form method="POST"
                                    action="<?=base_url("simlab/penghapusan-aset/update/" . $penghapusanaset->id_penghapusan_aset)?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="<?=$atlab->id_alat?>"
                                                <?=$penghapusanaset->id_alat == $atlab->id_alat ? 'selected' : ''?>>
                                                <?=$atlab->nama_alat?> (<?=$atlab->no_inventaris?>) -
                                                <?=$atlab->nama_ruang?></option>
                                            <?php endforeach;?>
                                        </select>
                                        <!-- Error Validation -->
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="stok" name="stok" class="form-control"
                                            placeholder="Jumlah Stok" value="<?=$atlab->stok?>" disabled />
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" id="jumlah_penghapusan" name="jumlah_penghapusan"
                                            ...
                                            value="<?=$penghapusanaset->jumlah_penghapusan?>"
                                            placeholder="Masukkan Jumlah Alat Laboratorium yang Dihapus/Keluar" />
                                        <!-- Error Validation -->
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" id="tanggal_penghapusan" name="tanggal_penghapusan"
                                            class="form-control  <?=($validation->hasError('tanggal_penghapusan')) ? 'is-invalid' : ''?>"
                                            value="<?= $penghapusanaset->tanggal_penghapusan ?>" />
                                        <!-- Error Validation -->
                                        <div class="invalid-feedback">
